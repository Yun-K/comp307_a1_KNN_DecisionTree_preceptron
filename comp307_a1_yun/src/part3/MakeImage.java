...
/**
 * Simple editor to construct and edit pmb image files. Not very robust!!!
 */
...
public class MakeImage implements MouseListener, MouseMotionListener {
    ...
    /**
     * Construct a new MakeImage object and set up the GUI
     */
    ...
    private void save(String fname) {
        try {
            if (fname == null) {
                do
                    fname = category
                            + ((category.equals(categoryName)) ? (++categoryCount) : (++otherCount))
                            + ".pbm";
