...
class DrawingCanvas extends Canvas {
     ...
     * 
     * public void print(Graphics g) { super.print(g); }
     * 
     */
    ...
    /**
     * Get the Graphics object that is the backing store of the image, so that programs can do
     * more complicated operations on the image than are provided by this class. <BR>
     * Standard usage would be to get the graphics object, call methods on it, and then call
     * the display() method on the Canvas to update the visible imagewith the modifications.
     */
    ...
    /**
     * Set the current foreground color - the color for all subsequent shapes or text
     */
